...
/* Modify getch() and ungetch() to handle EOF.
This is done by changing buf array to contain ints rather than chars, as EOF is an int
and WON'T fit in a char type. */
